...
class OstBeny extends Plugin
{
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_beny.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_beny.view_dir', $this->getPath() . '/Resources/views/');
